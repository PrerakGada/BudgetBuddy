...
class AnalyticCharts extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => AnalyticChartsState();
}

class AnalyticChartsState extends State<AnalyticCharts> {
  ...
  List<BarChartGroupData> showingGroups() => List.generate(5, (i) {
        switch (i) {
          case 0:
            return makeGroupData(0, 4, isTouched: i == touchedIndex);
          case 1:
  ...
  Widget getTitles(double value, TitleMeta meta) {
    ...
    switch (value.toInt()) {
      ...
      case 3:
        ...
        break;
      case 4:
        text = const Text('Education', style: style);
        break;
      default:
