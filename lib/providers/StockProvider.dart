...
class StockProvider extends ChangeNotifier {
  static Future<Chart> getStock() async {
    Response response = await get(Uri.parse(
        'https://query1.finance.yahoo.com/v8/finance/chart/SBIN.NS?region=IN&lang=en-US&comparisons=&includePrePost=false&interval=1m&useYfid=true&range=1d&corsDomain=finance.yahoo.com&.tsrc=finance'));
    return Chart.fromJson(jsonDecode(response.body)["chart"]["result"][0]);
  }
}
